...
install:
	...
	cp ems-peer.h ems-message.h ems-msg-queue.h ems-communicator.h ems-util.h ems-util-list.h ems-util-fd.h ems-status-messages.h ems.h ems-error.h ems-memory.h $(PREFIX)/include
